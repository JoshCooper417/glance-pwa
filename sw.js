...
function parseState(data) {
  ...
  // Oref categories: 1=rockets, 3=hostile aircraft, 5=tsunami, 6=infiltration → RED
  //                  14=preliminary warning → YELLOW
  if (cat === 1 || cat === 3 || cat === 5 || cat === 6) return 'red';
  if (cat === 14) return 'yellow';
  // Unknown category but our town is listed — treat as red
  return 'red';
}
